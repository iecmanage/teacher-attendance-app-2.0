        ...
        <div className="printable-document space-y-3">
          ...
          <div className="flex items-center justify-between border-b-2 border-emerald-900 pb-2">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-emerald-950 p-1 flex items-center justify-center border border-amber-500 shrink-0 shadow-sm">
                {settings.logoBase64 ? (
                  <img
            ...
            <div className="text-right">
              <span className="inline-block bg-emerald-950 text-amber-300 font-bold px-2.5 py-0.5 rounded text-[9.5px] uppercase tracking-wider">
                Monthly Report
              </span>
          ...
          <div className="grid grid-cols-5 gap-1.5 text-center text-xs">
            ...
            {!hideGeofenceColumn ? (
              <div className="p-1.5 bg-blue-50 rounded border border-blue-200 text-blue-900">
              ...
              <div className="p-1.5 bg-indigo-50 rounded border border-indigo-200 text-indigo-900">
              ...
              <tbody className="divide-y divide-slate-200">
                {monthDays.map((dateStr) => {
                  ...
                  return (
                    ...
                    >
                      <td className="py-1 px-2 font-mono font-semibold text-slate-900">{dateStr}</td>
                      <td className="py-1 px-2 font-bold text-slate-700">{dayName}</td>
                      ...
                      <td className="py-1 px-2">
                        <span
                          className={`px-1.5 py-0.5 rounded text-[8.5px] font-extrabold tracking-wide uppercase ${
                            status === 'ON_TIME'
                      ...
                      <td className="py-1 px-2 text-slate-600 truncate max-w-[150px]">
                        {rec?.notes || '-'}
                      </td>
                    </tr>
                  );
          ...
          <div className="pt-3 grid grid-cols-2 gap-12 text-center text-xs text-slate-700 page-break-avoid">
            <div>
              ...
              <p className="text-[9px] text-slate-500 mt-0.5">{teacher.name}</p>
            </div>
            <div>
              <div className="border-t-2 border-slate-400 pt-1.5 font-bold font-serif text-slate-900">
